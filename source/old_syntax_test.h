...
static void old_syntax_test() {
  ...
  data | _.adressof; 
  data | _.all_of([](int) { return true;}); 
  data | _.all_of_equal(8); 
  data | _.any_of([](int) { return true;}); 
  data | _.contains_if([](int) { return true;}); 
  data | _.any_of([](int) { return true;}); 
  ...
  data | _.cend; 
  data | _.count(8); 
  data | _.count_if([](int) { return true;}); 
  data | _.end; 
  data | _.find(8); 
  data | _.find_if_not([](int) { return true;}); 
  data | _.find_if([](int) { return true; }); 
  data | _.find_index(8); 
  data | _.find_index_if_not([](int) { return true;}); 
  data | _.find_index_if([](int) { return true; }); 
  ...
  data | _.move; 
  data.begin() | _.next; 
  data | _.none_of([](int) { return true;}); 
